...
public:
    ...
    const void giveBirth() {
        std::cout << Animal::name << " gave birth to a " << Animal::baby << std::endl;
    }
};
...
class Dog: public Mammal { // inheriting from Mammal class derived from Animal class, multilevel inheritance

};

class Human: public Mammal { // inheriting from Mammal class derived from Animal class, multilevel inheritance

};

class Chicken: public Bird { // inheriting from Bird class derived from Animal class, multilevel inheritance
